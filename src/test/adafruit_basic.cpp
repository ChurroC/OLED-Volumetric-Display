...
#define DC_PIN   13   // Data/Command - tells display if you're sending a command or pixel data
...
void setup() {
  ...
  display.drawLine(0, 0, SCREEN_WIDTH - 1, SCREEN_HEIGHT - 1, YELLOW); // Diagonal line
